  ...
  return (
    <>
      ...
      <div className="pt-[100px]">
        ...
        <motion.span {...fadeIn}>
          <motion.h1 {...fadeIn} className="font-black text-green-900 mt-[10vw] tablet:mt-[20vh] text-3xl text-center tablet:text-5xl mb-5">
           WELCOME TO PAMANTASAN NG LUNGSOD NG PASIG  
          </motion.h1>
        </motion.span>

        <motion.span className="flex justify-center items-center" {...fadeIn}>
          <motion.p {...fadeIn} className="text-yellow-600 poppins leading-tight text-center max-w-2xl tablet:text-lg mb-15 tablet:max-w-7xl">
        ...
        <div className="flex tablet flex-col tablet:flex-row gap-20 items-center justify-center mb-30">
          ...
          <motion.div className="flex flex-col justify-center items-center" {...fadeIn}>
            <motion.div className="flex mb-5 justify-center items-center bg-green-900 h-70 w-70" {...fadeIn}>
              <img src={Image1} className="w-50" />
            </motion.div>
            <motion.div className="h-20 w-70" {...fadeIn}>
              <h1 className="bebas text-green-900 text-3xl text-bold text-center">Academic Excellence</h1>
              <p className="text-center text-yellow-600  font-bold leading-tight max-w-3xl">
          ...
          <motion.div className="flex flex-col justify-center items-center" {...fadeIn}>
            ...
            <motion.div className="h-20 w-70" {...fadeIn}>
              <h1 className="bebas text-green-900 text-3xl text-bold text-center">Global Competitivenes</h1>
              <p className="text-center text-yellow-600 font-bold leading-tight max-w-3xl">
          ...
          <motion.div className="flex flex-col justify-center items-center" {...fadeIn}>
            ...
            <motion.div className="h-20 w-70" {...fadeIn}>
              <h1 className="bebas text-green-900 text-3xl text-bold text-center">Sustainable Environment</h1>
              <p className="text-center text-yellow-600 font-bold leading-tight max-w-3xl">
