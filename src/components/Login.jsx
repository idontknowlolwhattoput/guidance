...
function Login() {
  return (
      ...
      <div className="flex flex-row justify-center items-center gap-2 font-bold text-green-900">
        <div className="flex flex-col items-center justify-center gap-2">
        <img src={logo} className="w-20 h-20" />
        <p className="poppins text-3xl text-center leading-tight max-w-100">PAMANTASAN NG LUNGSOD NG PASIG</p>
        </div>
      </div>
        <form>
          ...
          <div className="grid grid-cols-2 justify-center items-center mt-3">
           <div className="flex gap-2 ">
             <input type="checkbox" id="check" className="accent-green-700"/>
             <label htmlFor ="check" className="font-semibold text-base">Show password</label>
           </div>
           <button className="text-base font-semibold text-end text-green-900">Forgot password?</button>
          </div>

          <div className="mt-7 grid grid-rows-1 gap-3">
            <button className="w-100 h-10 bg-green-900 text-white font-bold rounded-lg shadow-md hover:bg-green-600">Login</button>

            <div className="flex items-center my-4">
              <div className="flex-grow border-t border-green-400"></div>
              <span className="mx-2 text-green-500 font-bold">OR</span>
              <div className="flex-grow border-t border-green-400"></div>
            </div>
